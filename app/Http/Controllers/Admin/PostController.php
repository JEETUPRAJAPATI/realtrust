...
class PostController extends Controller
{
    ...
    {
        $posts = Post::latest()->withCount('comments')->with('admin')->get();
    ...
    public function edit($slug)
    {
        ...
        return view('admin.posts.edit', compact('categories', 'tags', 'post', 'selectedtag','selectedcategories'));
    }
    ...
    public function update(Request $request, $slug)
    {
        $request->validate([
            ...
            'image'     => 'mimes:jpeg,jpg,png,webp,gif,bmp,tiff,svg',
            'categories' => 'required',
            'tags'      => 'required',
            'body'      => 'required'
        ]);
