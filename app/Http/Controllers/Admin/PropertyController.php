...
class PropertyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.properties.create', compact('features', 'owners', 'amenities','locality'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Create Property
        $property = new Property();
        $property->owner_id  = $request->input('owner');;
        ...
        $property->latitude = $request->input('latitude') ?? null;
        $property->age = $request->input('age') ?? null;
        $property->longitude = $request->input('longitude') ?? null;
        ...
        if(($request->input('highlight') != 'null'))
        {
            $property->highlight_type = $request->input('highlight') ?? '';
        }
        // Store image paths
    ...
    {
        $property = Property::with(['owner'])->where('slug', $slug)->firstOrFail();
        ...
        return view('admin.properties.show', compact('property','localityName','society','city'));
    }
    ...
    public function edit($slug)
    {
        ...
        // dd($property);
        return view('admin.properties.edit', compact('property', 'features', 'owners', 'amenities','locality','additionalsDetail'));
    }
    ...
    {
        $request->validate([
            'status' => 'required|in:Active,Inactive,Reject,Draft,Request,Expired,Delete',
        ]);
    ...
    public function userList($property_id)
    {
        ...
        return view('admin.properties.user', compact('visiterInfo'));
    }
}
