                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="display:flex;gap: 8px;">
                                    ...
                                    <a href="{{ route('admin.schedule_properties.visit', $visiter->property_id) }}" class="btn btn-warning waves-effect waves-float" data-toggle="tooltip" data-placement="top" title="Schedule Visit">
