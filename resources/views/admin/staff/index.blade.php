        ...
        <div class="card">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="text-black mb-0">STAFF LIST</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{Storage::url('staff/'.$staff->image)}}" alt="{{$staff->name}}" width="100" class="img-responsive img-rounded">
                                        @else
                                    ...
                                    <td>
                                        <div class="text-center d-flex justify-content-center align-items-center">
                                            <a href="{{route('admin.staff.edit',$staff->id)}}" class="btn btn-info btn-sm waves-effect mx-1">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <a href="{{route('admin.staff.edit',$staff->id)}}" class="btn btn-success btn-sm waves-effect mx-1" data-bs-toggle="modal" data-bs-target="#verticalycentered">
                                                <i class="bi bi-key"></i>
                                            </a>
                                            <a href="{{route('admin.staff.permission',$staff->id)}}" class="btn btn-warning btn-sm waves-effect mx-1">
                                                <i class="bi bi-shield"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger btn-sm waves-effect" onclick="deleteStaff({{ $staff->id}})">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                            <form action="{{route('admin.staff.destroy',$staff->id)}}" method="POST" id="del-staff-{{$staff->id}}" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="passwordUpdateForm" action="{{ route('admin.password.update', $staff->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
