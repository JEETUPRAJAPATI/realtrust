                ...
                <form action="{{route('admin.changepassword')}}" method="POST">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{ $errors->has('currentpassword') ? 'focused error' : '' }}">
                            ...
                            <input type="password" name="currentpassword" class="form-control" value="{{ old('currentpassword') }}" required>
                        </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{ $errors->has('newpassword') ? 'focused error' : '' }}">
                            ...
                            <input type="password" name="newpassword" class="form-control" value="{{ old('newpassword') }}" required>
                        </div>
                        @error('newpassword')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{ $errors->has('newpassword_confirmation') ? 'focused error' : '' }}">
                            ...
                            <input type="password" name="newpassword_confirmation" class="form-control" value="{{ old('newpassword_confirmation') }}" required>
                        </div>
