...
<div class="col-xs-12">
        <div class="card">
            ...
            <div class="card-body mt-3">
                <form action="{{route('field_manager.profile')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($profile->image)
                        <div class="mt-2">
                            <img src="{{ Storage::url('field_manager/'.$profile->image) }}" alt="Profile Image" class="img-responsive img-rounded" width="100">
                        </div>
                        @endif
                    </div>
