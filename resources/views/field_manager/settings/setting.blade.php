    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="header bg-indigo">
                <h2>
                    GENERAL SETTING
                    <a href="{{route('field_manager.profile')}}" class="btn btn-info waves-effect waves-light right headerightbtn">
            ...
            <div class="body">
                <form action="{{route('field_manager.settings.store')}}" method="POST">
                    @csrf
