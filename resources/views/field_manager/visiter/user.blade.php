                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="display: flex; gap: 8px; justify-content: center;">
                                    ...
                                    <a href="{{ route('field_manager.visiter.edit', $visiter->id) }}"
                                    class="btn btn-success waves-effect waves-float"
                                    ...
                                    title="OTP Verification">
                                       ...
                                       <!-- View Button -->
                                       <!-- <a href="{{ route('field_manager.visiter.view', $visiter->id) }}"
                                    class="btn btn-warning waves-effect waves-float"
                                    data-toggle="tooltip" data-placement="top"
                                    title="View">
                                        <i class="bi bi-eye"></i>
                                    </a> -->
