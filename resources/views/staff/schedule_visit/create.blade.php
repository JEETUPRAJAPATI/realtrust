...
<form action="{{ route('staff.schedule_visit.manual_visit') }}" method="POST">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="card-header bg-indigo d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('staff.schedule_visit.index') }}" class="btn btn-light">
                ...
                <div class="card-body mt-3">
                    ...
                    <div class="form-group form-float mt-2">
                        ...
                        <div class="form-line">
                            <select id="visit_type" name="visit_type" class="form-control select2">
                                <option value="">Select Visit Type</option>
                                <option value="family">Family</option>
                                <option value="bachelorBoy">Bachelor Boys</option>
                                <option value="bachelorGirls">Bachelor Girls</option>
                    ...
                    <div class="form-group form-float mt-2">
                        ...
                        <div class="form-line">
                            <input type="text" name="company" id="company" class="form-control" placeholder="Enter company name" value="{{ old('company') }}">
                        </div>
                        @error('company')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <!-- Timing Field -->
                    <!--<div class="form-group form-float mt-2">-->
                    <!--    <label for="timing" class="form-label">Select Date and Time</label>-->
                    <!--    <div class="form-line">-->
                    <!--        <input type="text" class="form-control datetimepicker" name="timing" id="timing" value="{{ old('timing') }}">-->
                    <!--    </div>-->
                    <!--    @error('timing')-->
                    <!--    <span class="text-danger">{{ $message }}</span>-->
                    <!--    @enderror-->
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-sm mt-3 waves-effect">
                            <span>SAVE</span>
                        </button>
                    </div>
                </div>
