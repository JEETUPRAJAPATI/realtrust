    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-indigo d-flex justify-content-between align-items-center">
                <h4 class="text-black mb-0 card-title">SHOW INQUIRIES</h4>
                <a href="{{ route('staff.inquery.index') }}" class="btn btn-light">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="float-end">
                            <form id="status-form-{{ $inquery->id }}" action="{{ route('staff.inquery.updateStatus', ['id' => $inquery->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="btn-group">
