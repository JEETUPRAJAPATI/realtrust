    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="card-body mt-3">
                ...
                <div class="mt-2">
                    <a href="{{ route('staff.posts.index') }}" class="btn btn-danger btn-lg" data-toggle="tooltip" data-placement="top" title="Back to Posts">
                        <i class="bi bi-arrow-left-circle-fill"></i> <!-- Bootstrap Icon for Back -->
                        <span>BACK</span>
                    </a>

                    <a href="{{ route('staff.posts.edit', $post->slug) }}" class="btn btn-info btn-lg" data-toggle="tooltip" data-placement="top" title="Edit Post">
