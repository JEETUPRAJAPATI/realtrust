    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header bg-indigo">
                <h2>
                    EDIT FieldManager
                    <a href="{{route('staff.schedule_visit.index')}}" class="waves-effect waves-light btn btn-info right headerightbtn">
            ...
            <div class="body">
                <form action="{{route('staff.schedule_visit.update',$visiterInfo->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!-- Properties Dropdown -->
