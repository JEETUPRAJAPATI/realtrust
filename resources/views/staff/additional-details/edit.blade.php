...
@section('title', 'Edit Additional Details')
        ...
        <div class="card">
            <div class="body">
                <div class="card-header bg-indigo d-flex justify-content-between align-items-center">
                    <h4 class="text-black mb-0">EDIT ADDITIONAL DETAIL</h4>
                ...
                <div class="card-body mt-3">
                    <form action="{{ route('staff.additional-details.update', $detail->id) }}" method="POST">
                        @csrf
                        @method('PUT')
