        ...
        <div class="card">
            ...
            <div class="card-body mt-2">
                ...
                <li class="list-group-item">
                        ...
                        <span class="right">
                            <form id="status-form-{{ $property->id }}" action="{{ route('staff.properties.updateStatus', ['id' => $property->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="btn-group">
        ...
        <div class="card ">
            ...
            <div class="card-body mt-2 ">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <a href="{{ route('staff.properties.edit', $property->slug) }}" class="btn btn-info btn-lg waves-effect">
                        <span>EDIT</span>
                    </a>
                </div>
            </div>
