...
<div class="row clearfix">
    <form action="{{route('staff.properties.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body mt-3">
                        ...
                        <!--        <input type="text" name="title" placeholder="Enter Property Title" class="form-control" value="{{ old('title') }}">-->
                        <!--    </div>-->
                        <!--    @error('title')-->
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line">
                                ...
                                <input type="text" placeholder="Enter Block Number" class="form-control" name="block_no" value="{{ old('block_no') }}">
                            </div>
                            @error('block_no')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line">
                                ...
                                <input type="text" placeholder="Enter Flat Number" class="form-control" name="flat_no" value="{{ old('flat_no') }}">
                            </div>
                            @error('flat_no')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line">
                                <label class="form-label">Area (Sq Feet)<span class="text-danger">*</span></label>
                                <input type="number" placeholder="Enter Area" class="form-control" name="area" value="{{ old('area') }}">
                            </div>
                            @error('area')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <label for="description" class="col-md-2 col-form-label">Description<span class="text-danger">*</span></label><br>
                            <div class="mb-2">
                                <textarea name="description" placeholder="Enter Description" id="tinymce" class="form-control" rows="5">{{ old('description') }}</textarea>
                                @error('description')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line">
                                ...
                                <select name="additional_detail[]" id="additional_detail_tags" class="form-control show-tick select2-multiple" multiple>
                                    <!-- <option value="">-- Please select --</option> -->
                                    @foreach ($additionalsDetail as $detail)
                                    <option value="{{ $detail->name }}" {{ old('additional_detail') == $detail->name ? 'selected' : '' }}>
                                        {{ $detail->name }}
                                    </option>    
                                    @endforeach
                                </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body mt-3">
                        <!-- Price Section -->
                        <div class="form-group form-float mb-2" id="priceSection" style="display: {{ $errors->has('price') ? 'block' : 'none' }};">
                            <div class="form-line {{ $errors->has('price') ? 'focused error' : '' }}">
                                <label class="form-label">Price <span class="text-danger">*</span></label>
                                <input type="number" placeholder="Enter Price" class="form-control" name="price" value="{{ old('price') }}" min="0">
                            </div>
                            @error('price')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <!-- Price Range Section -->
                        <div class="form-group form-float mb-2" id="priceRangeSection" style="display: {{ $errors->has('price_range') ? 'block' : 'none' }};">
                            <div class="form-line {{ $errors->has('price_range') ? 'focused error' : '' }}">
                                ...
                                <input type="text" placeholder="Enter Price Range" class="form-control" name="price_range" value="{{ old('price_range') }}">
                            </div>
                            @error('price_range')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('maintenance') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Enter Maintenance" class="form-control" name="maintenance" value="{{ old('maintenance') }}" min="0">
                            </div>
                            @error('maintenance')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('monthly_rent') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Enter Monthly Rent" class="form-control" name="monthly_rent" value="{{ old('monthly_rent') }}" min="0">
                            </div>
                            @error('monthly_rent')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('deposit') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Enter Deposite" class="form-control" name="deposit" value="{{ old('deposit') }}" min="0">
                            </div>
                            @error('deposit')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div id="galleryImageSection" style="display: none; margin-top: 20px;">
                    <div class="card">
                        ...
                        <div class="card-body mt-3">
                            <input id="input-id" type="file" name="gallaryimage[]" class="file12" data-preview-file-type="text" multiple>
                            @error('gallaryimage')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            @error('gallaryimage.*')
                    ...
                    <div class="card-body mt-3">
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('tenant_type') ? 'focused error' : '' }}">
                                ...
                                <select name="tenant_type" class="form-control show-tick">
                                    ...
                                    <option value="anyone" {{ old('tenant_type') == 'anyone' ? 'selected' : '' }}>AnyOne</option>
                                </select>
                            </div>
                            @error('tenant_type')
                            <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('bedroom') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Number of Bedroom" class="form-control" name="bedroom" min="1" max="5" value="{{ old('bedroom') }}" maxlength="1" title="Please enter a number between 1 and 5">
                            </div>
                            @error('bedroom')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('bathroom') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Number of Bathroom" class="form-control" name="bathroom" min="1" max="5" value="{{ old('bathroom') }}" maxlength="1" title="Please enter a number between 1 and 5">
                            </div>
                            @error('bathroom')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('total_floor') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Number of Floors" class="form-control" name="total_floor" min="1" max="40" value="{{ old('total_floor') }}" title="Please enter a number between 1 and 40">
                            </div>
                            @error('total_floor')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('floor') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Floor Number" class="form-control" name="floor" min="1" max="40" value="{{ old('floor') }}" title="Please enter a number between 1 and 40">
                            </div>
                            @error('floor')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('balcony') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Number of Balcony" class="form-control" name="balcony" min="1" max="5" value="{{ old('balcony') }}" maxlength="1" title="Please enter a number between 1 and 5">
                            </div>
                            @error('balcony')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('bhk') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Enter BHK" class="form-control" name="bhk" min="1" max="5" value="{{ old('bhk') }}" maxlength="1" title="Please enter a number between 1 and 5">
                            </div>
                            @error('bhk')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group form-float mb-2">
                            <div class="form-line {{ $errors->has('age') ? 'focused error' : '' }}">
                                ...
                                <input type="number" placeholder="Age of Property" class="form-control" name="age" value="{{ old('age') }}">
                            </div>
                            @error('age')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const floorPlanSection = document.getElementById('floorPlanSection'); // Floor plan section

        const finance_detail = document.getElementById('finance_detail');
        ...
        if (purposeSelect && upcomingProjectsSection && galleryImageSection) {
            ...
            purposeSelect.addEventListener('change', function() {
                ...
                if (selectedValue === 'upcoming_projects') {
                    ...
                    finance_detail.style.display='none';
                ...
                // Toggle Gallery Image Section for Sell and Rent
                    ...
                    priceRangeSection.style.display = 'none';
                    priceSection.style.display = 'block';
                    finance_detail.style.display='block';
